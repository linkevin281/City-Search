...
# sorts the_list alphabetically A-Z and writes the output in cities_alpha_extra.txt
def sort_alpha(the_list, compare_func):
    sort(the_list, compare_func)
    write_output("txt files/cities_alpha_extra.txt")

# Parameters: the_list is a list of city objects, compare_func is a function
# sorts the_list by descending population and writes the output in cities_population_extra.txt
def sort_population(the_list, compare_func):
    sort(the_list, compare_func)
    write_output("txt files/cities_population_extra.txt")

# Parameters: the_list is a list of city objects, compare_func is a function
# sorts the_list by increasing latitude and writes the output in cities_latitude_extra.txt
def sort_latitude(the_list, compare_func):
    sort(the_list, compare_func)
    write_output("txt files/cities_latitude_extra.txt")
